$( document ).ready(function() {
    ...
    let todasLasCartas = [
        new Carta("LET y CONST", "img/let.png", "EDUCA+"),
        new Carta("IGUAL", "img/igual.png", " EDUCA+"),
        new Carta("COMPARACIÓN ESTRICTA", "img/compara1.png", " EDUCA+"),
        new Carta("COMPARACIÓN", "img/compara2.png", "EDUCA+"),
        new Carta("READY", "img/ready.png", "EDUCA+"),
        new Carta("$", "img/jquery.png", "EDUCA+"),
        new Carta("LÍNEA", "img/call.png", "EDUCA+"),
        new Carta("MEDIDAS RESPONSIVE", "img/responsive.png", "EDUCA+"),
    ]
